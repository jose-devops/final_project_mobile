...
class EditModalPedido extends StatefulWidget {
  ...
  const EditModalPedido({Key? key, required this.onSave, required this.clientes}) : super(key: key);

  @override
  State<EditModalPedido> createState() => _EditModalPedidoState();
}

class _EditModalPedidoState extends State<EditModalPedido> {
